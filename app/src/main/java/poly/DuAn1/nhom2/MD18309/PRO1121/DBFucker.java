...
public class DBFucker extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createTableCongViec = "CREATE TABLE CONGVIEC(idCV INTEGER PRIMARY KEY AUTOINCREMENT, idQuanLy REFERENCES TAIKHOAN(UserName), idNhanVien REFERENCES TAIKHOAN(UserName), TieuDe TEXT NOT NULL, MoTa TEXT NOT NULL, ThoiHan TEXT NOT NULL, TrangThai INTEGER NOT NULL, STATUS INTEGER NOT NULL)";
